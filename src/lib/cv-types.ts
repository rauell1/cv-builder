...
// actually the one that ran. One id, shown everywhere, is the whole point.
export const AVAILABLE_MODELS: AIModelConfig[] = [
  ...
  },
  {
    ...
    provider: 'nvidia',
    description: 'NVIDIA-tuned reasoning model, used when the primary model is unavailable',
    bestFor: 'ATS criteria analysis, deep job profiling, roles analysis',
    badge: 'Fallback',
  ...
  },
  {
    ...
    provider: 'nvidia',
    description: 'Small, fast model used as the last NVIDIA fallback before Gemini',
    bestFor: 'Quick parsing when larger models are unavailable',
    badge: 'Fast Fallback',
  ...
  },
  {
    ...
    provider: 'nvidia',
    description: 'Multimodal OCR model for scanned PDFs and images',
    bestFor: 'Scanned/image CV parsing, table extraction',
    badge: 'OCR',
