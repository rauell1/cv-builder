...
export const AI_PROVIDERS: { id: AIModelProvider; name: string; description: string; icon: string }[] = [
  { id: 'nvidia', name: 'NVIDIA NIM', description: 'NVIDIA Inference Microservices - fast, state-of-the-art hosted models', icon: '🟢' },
...
export const AVAILABLE_MODELS: AIModelConfig[] = [
  {
    ...
    provider: 'nvidia',
    description: 'NVIDIA state-of-the-art multilingual OCR model, excellent for layouts and tables',
    bestFor: 'High-fidelity CV parsing, scanned PDF layouts, table extraction',
  ...
  {
    id: 'z-ai/glm-5.2',
    name: 'GLM-5.2 (Agentic)',
    provider: 'nvidia',
    description: 'Flagship agentic model with 4M token context, designed for reasoning and tool use',
    bestFor: 'Web crawling, internet research, complex multi-step reasoning',
    badge: 'Agentic 4M',
  ...
  },
  {
    ...
    provider: 'nvidia',
    description: 'NVIDIA massive hybrid Mamba-Transformer model with 1M token context',
    bestFor: 'ATS criteria research, deep job profiling, roles analysis',
    badge: 'Ultra 550B',
  ...
  },
  {
    ...
    provider: 'nvidia',
    description: 'Flagship MoE model excelling at high-quality writing, coding, and JSON output',
